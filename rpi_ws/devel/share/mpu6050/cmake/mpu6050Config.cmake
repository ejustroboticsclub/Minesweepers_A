...
if("TRUE" STREQUAL "TRUE")
  set(mpu6050_SOURCE_PREFIX /home/pi/rpi_ws/src/mpu6050)
  set(mpu6050_DEVEL_PREFIX /home/pi/rpi_ws/devel)
  set(mpu6050_INSTALL_PREFIX "")
  set(mpu6050_PREFIX ${mpu6050_DEVEL_PREFIX})
else()
  set(mpu6050_SOURCE_PREFIX "")
  set(mpu6050_DEVEL_PREFIX "")
  set(mpu6050_INSTALL_PREFIX /home/pi/rpi_ws/install)
...
if(NOT "/home/pi/rpi_ws/devel/include;/home/pi/rpi_ws/src/mpu6050/include " STREQUAL " ")
  set(mpu6050_INCLUDE_DIRS "")
  set(_include_dirs "/home/pi/rpi_ws/devel/include;/home/pi/rpi_ws/src/mpu6050/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mpu6050' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/rpi_ws/src/mpu6050/${idir}'.  ${_report}")
    endif()
