...
echo_and_run cd "/home/pi/rpi_ws/src/rosserial/rosserial_client"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/pi/rpi_ws/src/rosserial/rosserial_client/setup.py" \
     \
    build --build-base "/home/pi/rpi_ws/build/rosserial/rosserial_client" \
    install \
    --root="${DESTDIR-/}" \
