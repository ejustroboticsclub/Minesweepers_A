...
echo_and_run cd "/home/pi/rpi_ws/src/rosserial/rosserial_vex_cortex"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/pi/rpi_ws/src/rosserial/rosserial_vex_cortex/setup.py" \
     \
    build --build-base "/home/pi/rpi_ws/build/rosserial/rosserial_vex_cortex" \
    install \
    --root="${DESTDIR-/}" \
