...
: ${AMENT_CURRENT_PREFIX:="/media/ahmed/Work/Robotics Club/MINE_A_ROS_2/station/install/map"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/map/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/map/environment/path.sh"
