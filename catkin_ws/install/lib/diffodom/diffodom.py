...
#############################################################################
    ...
    #############################################################################
        ...
        self.ticks_meter_r = float(rospy.get_param('ticks_meter', 2275))  # The number of wheel encoder ticks per meter of travel
        self.ticks_meter_l = float(rospy.get_param('ticks_meter', 3375))  # The number of wheel encoder ticks per meter of travel
