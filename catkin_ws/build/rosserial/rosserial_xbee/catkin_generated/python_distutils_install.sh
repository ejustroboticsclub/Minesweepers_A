...
echo_and_run cd "/home/ahmed/catkin_ws/src/rosserial/rosserial_xbee"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/ahmed/catkin_ws/src/rosserial/rosserial_xbee/setup.py" \
     \
    build --build-base "/home/ahmed/catkin_ws/build/rosserial/rosserial_xbee" \
    install \
    --root="${DESTDIR-/}" \
